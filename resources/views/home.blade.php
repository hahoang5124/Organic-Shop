...
@section('content')
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Chào mừng tới <br> Freshshop</strong></h1>
    ...
    <div class="categories-shop">
        <div class="container">
            <div class="row">
        @foreach ($categoryGhim as $category)
        ...
        <div class="container">
            ...
            <div class="row special-list">
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-6 special-grid {{ $product->categoryid }}">
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                <div class="type-lb">
                                    <p class="sale">Sale</p>
                                </div>
                                <img src="{{asset('storage/'.$product->img)}}" class="img-fluid" alt="Image">
                                <div class="mask-icon">
                                    <ul>
