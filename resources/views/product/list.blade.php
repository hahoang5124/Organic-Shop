                    ...
                    <div class="right-product-box">
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right d-flex">
                                    <span class="me-5">sắp xếp: </span>
                                    <select id="basic" class="form-control w-75 mt-1" data-placeholder="$ USD">
                                ...
                                <p>Hiện có {{count($products)}} sản phẩm</p>
                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="http://127.0.0.1:8000/storage/{{$product->img}}" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="{{ route('productDetail',$product->id) }}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        <div class="search-product">
                            <form method="get" action="{{ route('search','keyword') }}">
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <a href="{{ route('productsBycategory',$item->id) }}" class="list-group-item list-group-item-action">{{$item->name}}  <small class="text-muted">(150) </small></a>
                                @endforeach
                            </div>
                        </div>
